...
describe("sha256Hex", () => {
  it("matches published NIST/RFC vectors", () => {
  ...
  it("agrees with node:crypto across the message-padding boundaries", () => {
  ...
  it("is UTF-8 aware, not UTF-16 code-unit based", () => {
  ...
  it("agrees with node:crypto on realistic audit payloads", () => {
  ...
  it("avalanches — a one-character change alters the digest", () => {
...
describe("canonicalJson", () => {
  ...
  it("drops undefined members, matching a JSON round-trip", () => {

...
describe("duties", () => {
  it("refuses a posting with no duties", () => {
...
describe("validation", () => {
  ...
  it("accepts a plain whole number of seats", () => {
...
describe("building the posting", () => {
  it("produces a posting with no claims and nobody assigned", () => {
  ...
  it("posts to the board or holds it as a draft", () => {
  ...
  it("omits the optional fields rather than storing empty strings", () => {
  ...
  it("keeps a client when one is given — it is what makes the preference apply", () => {
  ...
  it("carries the duties through untouched", () => {

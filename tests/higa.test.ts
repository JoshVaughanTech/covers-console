...
describe("unpaid meal break (cl 16.2, 16.5, 16.6)", () => {
  ...
  it("accrues 50% loading past 6h with no meal", () => {
  ...
  it("records a historic (non-accruing) penalty on a completed shift", () => {
  ...
  it("reports an in-progress meal break", () => {
  ...
  it("without a roster, the entitlement escalates as hours accrue", () => {
...
describe("paid rest breaks (cl 16.2, 16.3, 16.7)", () => {
  it("requires one rest on a 9h shift once the meal is taken", () => {
  ...
  it("credits two 10-min rests as one 20-min rest", () => {
  ...
  it("owes an additional rest after 5h continuous post-meal (16.7a)", () => {
...
describe("board summary", () => {
  it("sorts by urgency and totals loading", () => {
